...
public class PaletaDeCoresPlanoDeFundo extends JDialog implements ActionListener {

	private JButton[] botao;
	private Color corBotaoClicado = (Color.BLUE);
	private AreaDeTexto areaDeTexto;
	
	public PaletaDeCoresPlanoDeFundo(MainWindow window, AreaDeTexto areaDeTexto) {
